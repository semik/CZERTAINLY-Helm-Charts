...
*/}}
{{- define "status-service.imagePullSecrets" -}}
...
*/}}
{{- define "status-service.ephemeralVolume" -}}
...
*/}}
{{- define "status-service.customization.initContainers" -}}
...
*/}}
{{- define "status-service.customization.sidecarContainers" -}}
...
*/}}
{{- define "status-service.customization.volumes" -}}
...
*/}}
{{- define "status-service.customization.volumeMounts" -}}
...
*/}}
{{- define "status-service.customization.ports" -}}
...
*/}}
{{- define "status-service.customization.env" -}}
...
*/}}
{{- define "status-service.customization.envFrom" -}}
